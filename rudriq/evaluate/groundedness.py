...
class GroundednessEvaluator:
    ...
    def evaluate(self, graph: TraceGraph) -> list[EvalResult]:
        ...
        for llm in llm_nodes:
            ...
            # output is a vector. Groundedness genuinely doesn't apply.
            # Mark not_applicable so the audit report can suppress
            # these from Notable findings (they're not a gap, they're
            # the wrong metric for this node kind).
                ...
                results.append(
                    EvalResult(
                        ...
                        explanation=(
                            ...
                            "not text — groundedness has no response to score."
                        ),
                        node_id=llm.node_id,
